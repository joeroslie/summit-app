  ...
  return (
    <div className="min-h-screen bg-zinc-100 text-zinc-900">
      {showToolsPanel && (
        ...
        >
          <div
            className="bg-white rounded-2xl shadow-xl max-w-md w-full p-5 border border-zinc-200"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between mb-4">
              <div className="text-lg font-semibold text-zinc-900">Tools</div>
              <button
                type="button"
                className="text-zinc-500 text-sm hover:text-zinc-800"
                onClick={() => setShowToolsPanel(false)}
              >
                Close
              </button>
            ...
            <div className="space-y-2">
              <button
                type="button"
                className="w-full text-left rounded-xl border border-zinc-200 p-3 hover:border-emerald-300 hover:bg-emerald-50/40 transition"
                onClick={() => {
                  setShowToolsPanel(false);
                  startMitigationInvoice(currentLeadId);
                }}
              >
                ...
                <div className="text-xs text-zinc-500">
                  Tarp / emergency — Rosalie LLC or ProWest
                </div>
              </button>
              <div className="w-full rounded-xl border border-dashed border-zinc-200 p-3 opacity-60">
                <div className="font-medium text-zinc-700">Canvassing</div>
                <div className="text-xs text-zinc-500">Coming soon</div>
              </div>
              <div className="w-full rounded-xl border border-dashed border-zinc-200 p-3 opacity-60">
                <div className="font-medium text-zinc-700">Weather / hail</div>
                <div className="text-xs text-zinc-500">Coming soon</div>
              </div>
            </div>
          </div>
            ...
            <div className="pb-8 w-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                <button
                  ...
                  className="group text-left bg-white border border-zinc-200/80 hover:border-emerald-300 hover:shadow-md hover:-translate-y-0.5 rounded-3xl p-7 sm:p-8 transition-all duration-200"
                >
                  <div className="text-xl sm:text-2xl font-semibold text-zinc-900 mb-1 group-hover:text-emerald-800 transition-colors">
                    Tools
                  </div>
                  <p className="text-sm text-zinc-500">
                    Mitigation, canvassing, weather
                  </p>
                </button>
              </div>
            </div>
