        ...
        {activeTab === 'home' && (() => {
          ...
          return (
            <div className="pb-8 w-full">
              ...
              {/* Tools + Calendar — below pipeline, side by side */}
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                <div className="lg:col-span-2">
                  <div className="text-sm font-semibold text-zinc-600 mb-3 tracking-wide">
                    TOOLS
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <button
                      type="button"
                      onClick={() => startMitigationInvoice(currentLeadId)}
                      className="text-left bg-white border border-zinc-200 rounded-2xl p-4 hover:border-emerald-300 hover:shadow-sm transition"
                    >
                      <div className="font-semibold text-zinc-900">
                        Mitigation invoice
                      </div>
                      <div className="text-xs text-zinc-500 mt-1">
                        Tarp / emergency bill — Rosalie LLC or ProWest
                      </div>
                    </button>
                    <div className="bg-zinc-50 border border-dashed border-zinc-200 rounded-2xl p-4 opacity-70">
                    ...
                    <div className="bg-zinc-50 border border-dashed border-zinc-200 rounded-2xl p-4 opacity-70">
                      <div className="font-semibold text-zinc-700">Canvassing</div>
                      <div className="text-xs text-zinc-500 mt-1">Coming soon</div>
                    </div>
                  </div>
                </div>
                ...
                <div
                  ...
                  className="group bg-white border border-zinc-200/80 hover:border-sky-300 hover:shadow-md hover:-translate-y-0.5 rounded-3xl p-7 sm:p-8 cursor-pointer transition-all duration-200 self-stretch flex flex-col justify-center"
                >
                  <div className="text-sm font-semibold text-zinc-600 mb-2 tracking-wide">
                    CALENDAR
                  </div>
                  <div className="text-xl sm:text-2xl font-semibold text-zinc-900 mb-1 group-hover:text-sky-900 transition-colors">
                    Schedule
