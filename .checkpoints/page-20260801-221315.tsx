...
const SYSTEM_DOCUMENTS = [
  ...
  {
    id: 'mitigation_personal',
    name: 'Personal mitigation invoice',
    description: 'Roslie Consulting Firm LLC · typically under $1,000',
  },
  {
    id: 'mitigation_company',
    name: 'Company mitigation invoice',
    description: 'ProWest Roofing · typically $1,000+',
  },
] as const;
...
export default function SummitApp() {
  ...
  const [systemDocWorkspace, setSystemDocWorkspace] = useState<
    null | 'takeoff' | 'pricing' | 'mitigation_personal' | 'mitigation_company'
  >(null);
  ...
  const openMitigationWorkspace = (
    ...
    const entity: MitigationEntity = kind === 'company' ? 'prowest' : 'roslie';
    const lead =
      fromLead && currentLeadId != null
    ...
    setSystemDocWorkspace(
      kind === 'company' ? 'mitigation_company' : 'mitigation_personal'
    );
    ...
    <div className="min-h-screen bg-zinc-100 text-zinc-900">
        ...
        {activeTab === 'documents' && (
          <div className="pb-8 w-full max-w-3xl">
                ...
                <button
                  ...
                  onClick={() => {
                    if (doc.id === 'takeoff') {
                      ...
                      setSystemDocPreview(null);
                    } else if (doc.id === 'mitigation_personal') {
                      openMitigationWorkspace('personal', false);
                    } else if (doc.id === 'mitigation_company') {
                      openMitigationWorkspace('company', false);
                    }
                  }}
            ...
            <p className="text-xs text-zinc-400 mt-6">
              Open Take-off, pricing, or mitigation invoices here, or on a lead use
              Documents → + Add → From system.
            </p>
          </div>
        )}
      ...
      {(systemDocWorkspace === 'mitigation_personal' ||
        ...
        <div className="fixed inset-0 z-[85] bg-zinc-50 overflow-y-auto">
          <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 py-6 pb-20">
            <div className="flex items-start justify-between gap-3 mb-6 sticky top-0 bg-zinc-50/95 backdrop-blur py-3 z-10">
              <div>
                ...
                <p className="text-xs text-zinc-500 mt-1">
                  {systemDocWorkspace === 'mitigation_company'
                    ? 'ProWest Roofing · licensed · typically $1,000+'
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-5 sm:p-6 space-y-5">
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  onClick={() => {
                    ...
                    setSystemDocWorkspace('mitigation_personal');
                  }}
                >
                  Personal
                </button>
                <button
                  ...
                  onClick={() => {
                    ...
                    setSystemDocWorkspace('mitigation_company');
                  }}
                >
                  Company
                </button>
                <span className="mx-1 text-zinc-300 self-center">|</span>
                <button
                  type="button"
                  className={`rounded-full px-3 py-1.5 text-xs font-medium border ${
                  ...
                  onClick={() =>
                    setMitigationDraft({ ...mitigationDraft, rateMode: 'insurance' })
                  }
                >
                  Insurance rates
                </button>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <label className="text-xs text-zinc-500 sm:col-span-2">
                  Invoice for
                  <input
                    className="mt-1 w-full border border-zinc-200 rounded-xl px-3 py-2.5 text-sm text-zinc-900"
                ...
                <label className="text-xs text-zinc-500">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMitigationDraft({ ...mitigationDraft, job: e.target.value })
                    }
                  />
                </label>
                <label className="text-xs text-zinc-500">
              ...
              <div>
                  ...
                  {mitigationPrices.length === 0 ? (
                    ...
                    mitigationPrices.map((row) => (
                      <button
                        key={row.item_key}
                        type="button"
                        className="text-xs rounded-full border border-zinc-200 px-2.5 py-1 hover:border-emerald-400 text-zinc-700"
                ...
                <div className="space-y-2">
                  {mitigationDraft.lines.length === 0 && (
                    <div className="text-sm text-zinc-400 py-4 text-center border border-dashed border-zinc-200 rounded-xl">
                  ...
                  {mitigationDraft.lines.map((ln) => (
                    <div
                      key={ln.id}
                      className="flex items-center gap-2 text-sm bg-zinc-50 rounded-xl px-3 py-2"
                    >
                      <div className="flex-1 truncate font-medium text-zinc-800">
                        {ln.label}
                      </div>
                      <input
                        type="number"
                        className="w-16 border border-zinc-200 rounded-lg px-2 py-1 bg-white"
                        value={ln.qty}
                        onChange={(e) =>
                      ...
                      />
                      <div className="w-20 text-right tabular-nums text-zinc-900">
              ...
              <button
                type="button"
                className="w-full rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-3 text-sm"
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      if (doc.id === 'takeoff') {
                                        ...
                                        openMitigationWorkspace('personal', true);
                                      } else if (doc.id === 'mitigation_company') {
                                        openMitigationWorkspace('company', true);
                                      } else if (doc.id === 'pricing') {
                                        setSystemDocWorkspace('pricing');
                                      }
                                    }}
