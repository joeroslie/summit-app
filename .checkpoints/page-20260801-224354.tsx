...
export default function SummitApp() {
  ...
  /** Invoices page: require an open lead (same idea as estimates). */
  const startNewInvoice = () => {
    ...
    setActiveTab('leads');
    showToast(
      'Open a lead first, then New invoice — or use Documents → + Add on the lead'
    );
  };
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl overflow-hidden">
              ...
              {appInvoices.length === 0 ? (
                <div className="p-8 text-center text-sm text-zinc-500">
                  No invoices yet. Open a lead and use New invoice, or Documents →
                  + Add on the lead.
                </div>
              ) : (
